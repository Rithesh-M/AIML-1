...
try:
    ...
    # --- FIX: Model 'gemini-2.5-pro' does not exist. Using 'gemini-1.5-pro'. ---
...
def run_app():
    ...
    if not st.session_state['logged_in']:
                    ...
                    if st.form_submit_button("Login", type="primary"):
                        if not username or not password:
                            ...
                            if user_ref.exists:
                                ...
                                if 'password_hash' in user_data and check_password(password, user_data['password_hash']):
        ...
        with col2:
            ...
            st.image("https://i.imgur.com/g0L6E8W.png", use_column_width=True) 
